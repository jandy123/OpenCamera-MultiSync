...
public class PreferenceKeys {
	...
	public static final String EnableRemote = "preference_enable_remote";
        ...
        public static final String EnableServer = "preference_enable_server";

		public static final String serverDelay = "preference_server_delay";

	    public static final String bleLatency = "preference_ble_latency";

     public static final String syncType = "preference_sync_type";
    
	    public static final String send_focus_exposure = "preference_send_client";

		public static final String server_name = "preference_server_name";
