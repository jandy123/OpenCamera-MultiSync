...
public class Constants {
    ...
    //LUK:
    public static final int SERVER_MSG_FIRST_STATE = 32; //1
    public static final int SERVER_MSG_SECOND_STATE = 48; //2;
    ...
    public static final UUID BODY_SENSOR_LOCATION_CHARACTERISTIC_UUID = UUID.fromString("00001524-1212-efde-1523-785feabcd123");
    public static final UUID KRAKEN_SENSORS_CHARACTERISTIC_UUID = UUID.fromString("00001625-1212-efde-1523-785feabcd123");
