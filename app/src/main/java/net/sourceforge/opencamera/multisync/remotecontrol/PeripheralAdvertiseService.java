...
public class PeripheralAdvertiseService extends Service {
    ...
    private final static String TAG = "PeripheralAdvertise service";
    /**
     ...
     */
    //LUK: stopping advertising causes disconnect; this should not happen!!!
    private long TIMEOUT = TimeUnit.MILLISECONDS.convert(100, TimeUnit.MINUTES);
