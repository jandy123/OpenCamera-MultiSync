...
public abstract class CameraController {
	...
	public interface PictureCallback {
		PictureCallback init(MainActivity activity);
	...
	public abstract CaptureRequest.Builder getPreviewBuilder();
	public abstract Handler getHandler();
	public abstract void playShutterSound();
	public abstract void capture(CaptureRequest request) throws CameraAccessException;
	public abstract CameraDevice getCameraDevice();
	public abstract float getDisparity(float dst);
