...
public class CameraControllerSync {
  ...
  public final ImageMetadataSynchronizer imageMetadataSynchronizer;
  ...
  public CameraControllerSync(
    ...
    //LUK: phase sync; important to increase this to 2, otherwise framerate drops from 40ms to 80ms and period is messed up;
    //see also Preview.setPreviewFps selectedfps and CameraController2.setAEMode builder.set(CaptureRequest.SENSOR_FRAME_DURATION, sensor_frame_duration);
    final int imageBuffer = 2;
